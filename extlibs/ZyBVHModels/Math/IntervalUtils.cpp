...
namespace BVHModels
{
    ...
    bool IntrAxis<Real>::Test (const Vec<3,Real>& axis,
    ...
    //----------------------------------------------------------------------------
    template <typename Real>
    bool IntrAxis<Real>::Test (const Vec<3,Real>& axis, const Box3<Real>& box0,
        const Box3<Real>& box1, const Vec<3,Real>& velocity, Real tmax,
    ...
    //----------------------------------------------------------------------------
    template <typename Real>
    bool IntrAxis<Real>::Find (const Vec<3,Real>& axis,
        const Vec<3,Real> segment[2], const Triangle3<Real>& triangle,
    ...
    //----------------------------------------------------------------------------
    template <typename Real>
    void IntrAxis<Real>::GetProjection (const Vec<3,Real>& axis,
        ...
        const Box3<Real>& box, Real& imin, Real& imax)
    {
        ...
        Real maximumExtent =
            MathUtils<Real>::FAbs(box.Extent[0] * (axis * box.Axis[0])) +
            MathUtils<Real>::FAbs(box.Extent[1] * (axis * box.Axis[1])) +
            MathUtils<Real>::FAbs(box.Extent[2] * (axis * box.Axis[2]));
    ...
    //----------------------------------------------------------------------------
    template <typename Real>
    void IntrAxis<Real>::GetConfiguration (const Vec<3,Real>& axis,
        const Vec<3,Real> segment[2], IntrConfiguration<Real>& cfg)
    {
        ...
        if (MathUtils<Real>::FAbs(dot[1] - dot[0]) < MathUtils<Real>::ZERO_TOLERANCE)
        {
        ...
        const Box3<Real>& box, IntrConfiguration<Real>& cfg)
    {
        ...
        Real absAxes[3] =
        {
            MathUtils<Real>::FAbs(axes[0]),
            MathUtils<Real>::FAbs(axes[1]),
            MathUtils<Real>::FAbs(axes[2])
        };

        Real maxProjectedExtent;

        if (absAxes[0] < MathUtils<Real>::ZERO_TOLERANCE)
        {
            if (absAxes[1] < MathUtils<Real>::ZERO_TOLERANCE)
            {
                // face-face
            ...
            else if (absAxes[2] < MathUtils<Real>::ZERO_TOLERANCE)
            {
                // face-face
                cfg.mMap = IntrConfiguration<Real>::m44;
        ...
        else if (absAxes[1] < MathUtils<Real>::ZERO_TOLERANCE)
        {
            if (absAxes[2] < MathUtils<Real>::ZERO_TOLERANCE)
            {
                // face-face
                cfg.mMap = IntrConfiguration<Real>::m44;
    ...
    //----------------------------------------------------------------------------
    template <typename Real>
    void FindContactSet<Real>::FindContactSet_Segment3Triangle3 (const Vec<3,Real> segment[2],
    ...
    //----------------------------------------------------------------------------
    template <typename Real>
    void FindContactSet<Real>::FindContactSet_Segment3Box3 (const Vec<3,Real> segment[2],
    ...
    //----------------------------------------------------------------------------
    template <typename Real>
    void FindContactSet<Real>::FindContactSet_Triangle3Box3 (const Triangle3<Real>& triangle,
    ...
    //----------------------------------------------------------------------------
    template <typename Real>
    void FindContactSet<Real>::FindContactSet_Box3Box3 (const Box3<Real>& box0,
    ...
    //----------------------------------------------------------------------------
    template <typename Real>
    void FindContactSet<Real>::ColinearSegments (const Vec<3,Real> segment0[2],
    ...
    //----------------------------------------------------------------------------
    template <typename Real>
    void FindContactSet<Real>::SegmentSegment (const Vec<3,Real> segment0[2],
        const Vec<3,Real> segment1[2], int& quantity, Vec<3,Real>* P)
    {
        ...
        if (sqrLenN < MathUtils<Real>::ZERO_TOLERANCE*sqrLen0*sqrLen1)
        {
        ...
        Real constant, int& quantity, Vec<3,Real>* P)
    {
        ...
        for (i = 0; i < quantity; ++i)
        {
            ...
            test[i] = (normal * P[i]) - constant +
                MathUtils<Real>::FAbs(constant) * MathUtils<Real>::ZERO_TOLERANCE;
    ...
    //----------------------------------------------------------------------------
    template <typename Real>
    Interval1Intersector<Real>::Interval1Intersector (Real u0, Real u1, Real v0, Real v1)
    {
    ...
    //----------------------------------------------------------------------------
    template <typename Real>
    Interval1Intersector<Real>::Interval1Intersector (Real u[2], Real v[2])
    {
    ...
    //----------------------------------------------------------------------------
    template <typename Real>
    Interval1Intersector<Real>::~Interval1Intersector ()
    {
    }
    //----------------------------------------------------------------------------
    template <typename Real>
    Real Interval1Intersector<Real>::GetU (int i) const
    {
        return mU[i];
    }
    //----------------------------------------------------------------------------
    template <typename Real>
    Real Interval1Intersector<Real>::GetV (int i) const
    {
        return mV[i];
    }
    //----------------------------------------------------------------------------
    template <typename Real>
    bool Interval1Intersector<Real>::Test ()
    {
        return mU[0] <= mV[1] && mU[1] >= mV[0];
    }
    //----------------------------------------------------------------------------
    template <typename Real>
    bool Interval1Intersector<Real>::Find ()
    {
    ...
    //----------------------------------------------------------------------------
    template <typename Real>
    bool Interval1Intersector<Real>::Test (Real tmax, Real speedU, Real speedV)
    {
        ...
        else
        {
            ...
            {
                mLastTime = MathUtils<Real>::MAX_REAL;
            }
    ...
    //----------------------------------------------------------------------------
    template <typename Real>
    bool Interval1Intersector<Real>::Find (Real tmax, Real speedU, Real speedV)
    {
        Real diffSpeed, invDiffSpeed, diffPos;
    ...
    //----------------------------------------------------------------------------
    template <typename Real>
    Real Interval1Intersector<Real>::GetFirstTime () const
    {
        return mFirstTime;
    }
    //----------------------------------------------------------------------------
    template <typename Real>
    Real Interval1Intersector<Real>::GetLastTime () const
    {
        return mLastTime;
    }
    //----------------------------------------------------------------------------
    template <typename Real>
    int Interval1Intersector<Real>::GetNumIntersections () const
    {
        return mNumIntersections;
    }
    //----------------------------------------------------------------------------
    template <typename Real>
    Real Interval1Intersector<Real>::GetIntersection (int i) const
    {
