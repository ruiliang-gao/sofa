...
Real MathUtils<Real>::ACos (Real value)
{
    if (-(Real)1 < value)
    {
        if (value < (Real)1)
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::ASin (Real value)
{
    if (-(Real)1 < value)
    {
        if (value < (Real)1)
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::ATan (Real value)
{
    return atan(value);
}
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::ATan2 (Real y, Real x)
{
    ...
    {
        // MathUtilsematically, ATan2(0,0) is undefined, but ANSI standards
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::Ceil (Real value)
{
    return ceil(value);
}
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::Cos (Real value)
{
    return cos(value);
}
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::Exp (Real value)
{
    return exp(value);
}
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::FAbs (Real value)
{
    return fabs(value);
}
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::Floor (Real value)
{
    return floor(value);
}
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::FMod (Real x, Real y)
{
    if (y != (Real)0)
    {
        return fmod(x, y);
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::InvSqrt (Real value)
{
    if (value != (Real)0)
    {
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::Log (Real value)
{
    if (value > (Real)0)
    {
        return log(value);
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::Log2 (Real value)
{
    if (value > (Real)0)
    {
        return MathUtils<Real>::INV_LN_2 * log(value);
    }
    else
    {
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::Log10 (Real value)
{
    if (value > (Real)0)
    {
        return MathUtils<Real>::INV_LN_10 * log(value);
    }
    else
    {
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::Pow (Real base, Real exponent)
{
    if (base >= (Real)0)
    {
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::Sin (Real value)
{
    return sin(value);
}
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::Sqr (Real value)
{
    return value*value;
}
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::Sqrt (Real value)
{
    if (value >= (Real)0)
    {
        return sqrt(value);
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::Tan (Real value)
{
    return tan(value);
}
//----------------------------------------------------------------------------
template <typename Real>
int MathUtils<Real>::Sign (int value)
{
    if (value > 0)
    {
        return 1;
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::Sign (Real value)
{
    if (value > (Real)0)
    {
        return (Real)1;
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::UnitRandom (unsigned int seed)
{
    if (seed > 0)
    {
        srand(seed);
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::SymmetricRandom (unsigned int seed)
{
    return ((Real)2)*UnitRandom(seed) - (Real)1;
}
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::IntervalRandom (Real min, Real max, unsigned int seed)
{
    return min + (max - min)*UnitRandom(seed);
}
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::Clamp (Real value, Real minValue, Real maxValue)
{
    if (value <= minValue)
    {
         return minValue;
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::Saturate (Real value)
{
    if (value <= (Real)0)
    {
         return (Real)0;
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::FastSin0 (Real angle)
{
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::FastSin1 (Real angle)
{
    Real angleSqr = angle*angle;
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::FastCos0 (Real angle)
{
    Real angleSqr = angle*angle;
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::FastCos1 (Real angle)
{
    Real angleSqr = angle*angle;
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::FastTan0 (Real angle)
{
    Real angleSqr = angle*angle;
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::FastTan1 (Real angle)
{
    Real angleSqr = angle*angle;
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::FastInvSin0 (Real value)
{
    Real root = MathUtils<Real>::Sqrt(FAbs((Real)1 - value));
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::FastInvSin1 (Real value)
{
    Real root = MathUtils<Real>::Sqrt(FAbs((Real)1 - value));
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::FastInvCos0 (Real value)
{
    Real root = MathUtils<Real>::Sqrt(FAbs((Real)1 - value));
    Real result = -(Real)0.0187293;
    result *= value;
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::FastInvCos1 (Real value)
{
    Real root = MathUtils<Real>::Sqrt(FAbs((Real)1 - value));
    Real result = -(Real)0.0012624911;
    result *= value;
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::FastInvTan0 (Real value)
{
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::FastInvTan1 (Real value)
{
    Real valueSqr = value*value;
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::FastNegExp0 (Real value)
{
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::FastNegExp1 (Real value)
{
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::FastNegExp2 (Real value)
{
...
//----------------------------------------------------------------------------
template <typename Real>
Real MathUtils<Real>::FastNegExp3 (Real value)
{
...
//----------------------------------------------------------------------------
template <typename Real>
void MathUtils<Real>::Orthonormalize (Vec<3,Real>& u, Vec<3,Real>& v, Vec<3,Real>& w)
{
...
//----------------------------------------------------------------------------
template <typename Real>
void MathUtils<Real>::Orthonormalize (Vec<3,Real>* v)
{
...
//----------------------------------------------------------------------------
template <typename Real>
void MathUtils<Real>::GenerateComplementBasis (Vec<3,Real>& u, Vec<3,Real>& v,
    const Vec<3,Real>& w)
{
    Real invLength;

    if (MathUtils<Real>::FAbs(w[0]) >= MathUtils<Real>::FAbs(w[1]))
    {
        // W.x or W.z is the largest magnitude component, swap them
        invLength = MathUtils<Real>::InvSqrt(w[0] * w[0] +
            w[2] * w[2]);
        u[0] = -w[2] * invLength;
        u[1] = (Real)0;
        u[2] = +w[0] * invLength;
    ...
    else
    {
        ...
        invLength = MathUtils<Real>::InvSqrt(w[1] * w[1] +
            w[2] * w[2]);
        u[0] = (Real)0;
        u[1] = +w[2] * invLength;
        u[2] = -w[1] * invLength;
