#ifndef BVHMODELS_QUERY2_H
#define BVHMODELS_QUERY2_H
...
namespace BVHModels
{
    ...
    public:
        ...
        Query2 (int numVertices, const Vec<2,Real>* vertices);
        virtual ~Query2 ();
        ...
        inline const Vec<2,Real>* GetVertices () const;
        ...
        virtual int ToLine (const Vec<2,Real>& test, int v0, int v1) const;
        ...
        virtual int ToTriangle (const Vec<2,Real>& test, int v0, int v1,
            int v2) const;
        ...
        virtual int ToCircumcircle (const Vec<2,Real>& test, int v0, int v1,
            int v2) const;
