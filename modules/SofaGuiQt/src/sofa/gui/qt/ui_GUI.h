...
<ui version="4.0">
 <exportmacro>SOFA_SOFAGUIQT_API</exportmacro>
 <class>GUI</class>
           ...
           <layout class="QVBoxLayout" name="_21">
            <item>
             <widget class="QCheckBox" name="dumpStateCheckBox">
              <property name="toolTip">
               <string comment="This is used to plut curves fter a simulation">Record the state at each time step in file &quot;dumpState.data&quot;</string>
              </property>
              <property name="text">
            ...
            <item>
             <widget class="QCheckBox" name="displayTimeProfiler">
              <property name="text">
               <string>Display AdvanceTimer profiler</string>
              </property>
             </widget>
            </item>
           </layout>
 ...
 <includes>
  <include location="local">sofa/gui/qt/config.h</include>
 </includes>
 <resources/>
 <connections>
  <connection>
