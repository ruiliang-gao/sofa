...
#include "PBDynamics/PositionBasedElasticRods.h"
...
// BallJoint
//////////////////////////////////////////////////////////////////////////
bool BallJoint::initConstraint(PBDSimulationModel &model, const unsigned int rbIndex1, const unsigned int rbIndex2, const Vector3r &pos)
{
    m_bodies[0] = rbIndex1;
    m_bodies[1] = rbIndex2;
...
bool BallJoint::updateConstraint(PBDSimulationModel &model)
{
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
    PBDRigidBody &rb1 = *rb[m_bodies[0]];
    PBDRigidBody &rb2 = *rb[m_bodies[1]];
...
bool BallJoint::solvePositionConstraint(PBDSimulationModel &model, const unsigned int iter)
{
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
...
// BallOnLineJoint
//////////////////////////////////////////////////////////////////////////
bool BallOnLineJoint::initConstraint(PBDSimulationModel &model, const unsigned int rbIndex1, const unsigned int rbIndex2, const Vector3r &pos, const Vector3r &dir)
{
    m_bodies[0] = rbIndex1;
    m_bodies[1] = rbIndex2;
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
...
bool BallOnLineJoint::updateConstraint(PBDSimulationModel &model)
{
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
    PBDRigidBody &rb1 = *rb[m_bodies[0]];
    PBDRigidBody &rb2 = *rb[m_bodies[1]];
...
bool BallOnLineJoint::solvePositionConstraint(PBDSimulationModel &model, const unsigned int iter)
{
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
...
// HingeJoint
//////////////////////////////////////////////////////////////////////////
bool HingeJoint::initConstraint(PBDSimulationModel &model, const unsigned int rbIndex1, const unsigned int rbIndex2, const Vector3r &pos, const Vector3r &axis)
{
    m_bodies[0] = rbIndex1;
    m_bodies[1] = rbIndex2;
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
...
bool HingeJoint::updateConstraint(PBDSimulationModel &model)
{
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
    PBDRigidBody &rb1 = *rb[m_bodies[0]];
    PBDRigidBody &rb2 = *rb[m_bodies[1]];
...
bool HingeJoint::solvePositionConstraint(PBDSimulationModel &model, const unsigned int iter)
{
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
...
// UniversalJoint
//////////////////////////////////////////////////////////////////////////
bool UniversalJoint::initConstraint(PBDSimulationModel &model, const unsigned int rbIndex1, const unsigned int rbIndex2, const Vector3r &pos, const Vector3r &axis1, const Vector3r &axis2)
{
    m_bodies[0] = rbIndex1;
    m_bodies[1] = rbIndex2;
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
...
bool UniversalJoint::updateConstraint(PBDSimulationModel &model)
{
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
    PBDRigidBody &rb1 = *rb[m_bodies[0]];
    PBDRigidBody &rb2 = *rb[m_bodies[1]];
...
bool UniversalJoint::solvePositionConstraint(PBDSimulationModel &model, const unsigned int iter)
{
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
...
// SliderJoint
//////////////////////////////////////////////////////////////////////////
bool SliderJoint::initConstraint(PBDSimulationModel &model, const unsigned int rbIndex1, const unsigned int rbIndex2, const Vector3r &pos, const Vector3r &axis)
{
    m_bodies[0] = rbIndex1;
    m_bodies[1] = rbIndex2;
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
...
bool SliderJoint::updateConstraint(PBDSimulationModel &model)
{
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
    PBDRigidBody &rb1 = *rb[m_bodies[0]];
    PBDRigidBody &rb2 = *rb[m_bodies[1]];
...
bool SliderJoint::solvePositionConstraint(PBDSimulationModel &model, const unsigned int iter)
{
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
...
//////////////////////////////////////////////////////////////////////////
bool TargetPositionMotorSliderJoint::initConstraint(PBDSimulationModel &model, const unsigned int rbIndex1, const unsigned int rbIndex2, const Vector3r &pos, const Vector3r &axis)
{
    m_bodies[0] = rbIndex1;
    m_bodies[1] = rbIndex2;
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
...
bool TargetPositionMotorSliderJoint::updateConstraint(PBDSimulationModel &model)
{
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
    PBDRigidBody &rb1 = *rb[m_bodies[0]];
    PBDRigidBody &rb2 = *rb[m_bodies[1]];
...
bool TargetPositionMotorSliderJoint::solvePositionConstraint(PBDSimulationModel &model, const unsigned int iter)
{
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
...
//////////////////////////////////////////////////////////////////////////
bool TargetVelocityMotorSliderJoint::initConstraint(PBDSimulationModel &model, const unsigned int rbIndex1, const unsigned int rbIndex2, const Vector3r &pos, const Vector3r &axis)
{
    m_bodies[0] = rbIndex1;
    m_bodies[1] = rbIndex2;
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
...
bool TargetVelocityMotorSliderJoint::updateConstraint(PBDSimulationModel &model)
{
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
    PBDRigidBody &rb1 = *rb[m_bodies[0]];
    PBDRigidBody &rb2 = *rb[m_bodies[1]];
...
bool TargetVelocityMotorSliderJoint::solvePositionConstraint(PBDSimulationModel &model, const unsigned int iter)
{
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
...
bool TargetVelocityMotorSliderJoint::solveVelocityConstraint(PBDSimulationModel &model, const unsigned int iter)
{
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
...
//////////////////////////////////////////////////////////////////////////
bool TargetAngleMotorHingeJoint::initConstraint(PBDSimulationModel &model, const unsigned int rbIndex1, const unsigned int rbIndex2, const Vector3r &pos, const Vector3r &axis)
{
    m_bodies[0] = rbIndex1;
    m_bodies[1] = rbIndex2;
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
...
bool TargetAngleMotorHingeJoint::updateConstraint(PBDSimulationModel &model)
{
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
    PBDRigidBody &rb1 = *rb[m_bodies[0]];
    PBDRigidBody &rb2 = *rb[m_bodies[1]];
...
bool TargetAngleMotorHingeJoint::solvePositionConstraint(PBDSimulationModel &model, const unsigned int iter)
{
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
...
//////////////////////////////////////////////////////////////////////////
bool TargetVelocityMotorHingeJoint::initConstraint(PBDSimulationModel &model, const unsigned int rbIndex1, const unsigned int rbIndex2, const Vector3r &pos, const Vector3r &axis)
{
    m_bodies[0] = rbIndex1;
    m_bodies[1] = rbIndex2;
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
...
bool TargetVelocityMotorHingeJoint::updateConstraint(PBDSimulationModel &model)
{
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
    PBDRigidBody &rb1 = *rb[m_bodies[0]];
    PBDRigidBody &rb2 = *rb[m_bodies[1]];
...
bool TargetVelocityMotorHingeJoint::solvePositionConstraint(PBDSimulationModel &model, const unsigned int iter)
{
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
...
bool TargetVelocityMotorHingeJoint::solveVelocityConstraint(PBDSimulationModel &model, const unsigned int iter)
{
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
...
//////////////////////////////////////////////////////////////////////////
bool RigidBodyParticleBallJoint::initConstraint(PBDSimulationModel &model, const unsigned int rbIndex, const unsigned int particleIndex)
{
    m_bodies[0] = rbIndex;
...
// RigidBodySpring
//////////////////////////////////////////////////////////////////////////
bool RigidBodySpring::initConstraint(PBDSimulationModel &model, const unsigned int rbIndex1, const unsigned int rbIndex2, const Vector3r &pos1, const Vector3r &pos2, const Real stiffness)
{
...
bool RigidBodySpring::updateConstraint(PBDSimulationModel &model)
{
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
    PBDRigidBody &rb1 = *rb[m_bodies[0]];
    PBDRigidBody &rb2 = *rb[m_bodies[1]];
...
bool RigidBodySpring::solvePositionConstraint(PBDSimulationModel &model, const unsigned int iter)
{
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
...
// DistanceConstraint
//////////////////////////////////////////////////////////////////////////
bool DistanceConstraint::initConstraint(PBDSimulationModel &model, const unsigned int particle1, const unsigned int particle2)
{
...
bool DistanceConstraint::solvePositionConstraint(PBDSimulationModel &model, const unsigned int iter)
{
    ...
    const bool res = PositionBasedDynamics::solve_DistanceConstraint(
                ...
                m_restLength,
                //model.getValue<Real>(PBDSimulationModel::CLOTH_STIFFNESS), model.getValue<Real>(PBDSimulationModel::CLOTH_STIFFNESS),
                model.CLOTH_STIFFNESS.getValue(), model.CLOTH_STIFFNESS.getValue(),
                corr1, corr2);
...
bool DihedralConstraint::initConstraint(PBDSimulationModel &model, const unsigned int particle1, const unsigned int particle2,
...
bool DihedralConstraint::solvePositionConstraint(PBDSimulationModel &model, const unsigned int iter)
{
    ...
    const bool res = PositionBasedDynamics::solve_DihedralConstraint(
                ...
                m_restAngle,
                //model.getValue<Real>(PBDSimulationModel::CLOTH_BENDING_STIFFNESS),
                model.CLOTH_BENDING_STIFFNESS.getValue(),
...
//////////////////////////////////////////////////////////////////////////
bool IsometricBendingConstraint::initConstraint(PBDSimulationModel &model, const unsigned int particle1, const unsigned int particle2,
                                                const unsigned int particle3, const unsigned int particle4)
{
    m_bodies[0] = particle1;
    m_bodies[1] = particle2;
...
//////////////////////////////////////////////////////////////////////////
bool FEMTriangleConstraint::initConstraint(PBDSimulationModel &model, const unsigned int particle1, const unsigned int particle2,
...
bool FEMTriangleConstraint::solvePositionConstraint(PBDSimulationModel &model, const unsigned int iter)
{
    ...
    const bool res = PositionBasedDynamics::solve_FEMTriangleConstraint(
                ...
                m_area,
                m_invRestMat,
                /*model.getValue<Real>(PBDSimulationModel::CLOTH_STIFFNESS_XX),
                model.getValue<Real>(PBDSimulationModel::CLOTH_STIFFNESS_YY),
                model.getValue<Real>(PBDSimulationModel::CLOTH_STIFFNESS_XY),
                model.getValue<Real>(PBDSimulationModel::CLOTH_POISSON_RATIO_XY),
                model.getValue<Real>(PBDSimulationModel::CLOTH_POISSON_RATIO_YX),*/
                model.CLOTH_STIFFNESS_XX.getValue(),
                model.CLOTH_STIFFNESS_YY.getValue(),
                model.CLOTH_STIFFNESS_XY.getValue(),
                model.CLOTH_POISSON_RATIO_XY.getValue(),
                model.CLOTH_POISSON_RATIO_YX.getValue(),
                corr1, corr2, corr3);
...
//////////////////////////////////////////////////////////////////////////
bool StrainTriangleConstraint::initConstraint(PBDSimulationModel &model, const unsigned int particle1, const unsigned int particle2,
                                              const unsigned int particle3)
{
    m_bodies[0] = particle1;
    m_bodies[1] = particle2;
...
bool StrainTriangleConstraint::solvePositionConstraint(PBDSimulationModel &model, const unsigned int iter)
{
    ...
    const bool res = PositionBasedDynamics::solve_StrainTriangleConstraint(
                ...
                model.getValue<Real>(PBDSimulationModel::CLOTH_STIFFNESS_YY),
                model.getValue<Real>(PBDSimulationModel::CLOTH_STIFFNESS_XY),
                model.getValue<bool>(PBDSimulationModel::CLOTH_NORMALIZE_STRETCH),
                model.getValue<bool>(PBDSimulationModel::CLOTH_NORMALIZE_SHEAR),*/
                model.CLOTH_STIFFNESS_XX.getValue(),
                model.CLOTH_STIFFNESS_YY.getValue(),
                model.CLOTH_STIFFNESS_XY.getValue(),
                model.CLOTH_NORMALIZE_STRETCH.getValue(),
                model.CLOTH_NORMALIZE_SHEAR.getValue(),
                corr1, corr2, corr3);
...
bool VolumeConstraint::initConstraint(PBDSimulationModel &model, const unsigned int particle1, const unsigned int particle2,
                                      const unsigned int particle3, const unsigned int particle4)
{
    m_bodies[0] = particle1;
    m_bodies[1] = particle2;
...
bool VolumeConstraint::solvePositionConstraint(PBDSimulationModel &model, const unsigned int iter)
{
    ...
    const bool res = PositionBasedDynamics::solve_VolumeConstraint(x1, invMass1,
                                                                   ...
                                                                   x4, invMass4,
                                                                   m_restVolume,
                                                                   //model.getValue<Real>(PBDSimulationModel::SOLID_STIFFNESS),
                                                                   //model.getValue<Real>(PBDSimulationModel::SOLID_STIFFNESS),
                                                                   model.SOLID_STIFFNESS.getValue(),
                                                                   model.SOLID_STIFFNESS.getValue(),
                                                                   corr1, corr2, corr3, corr4);
...
// FEMTetConstraint
//////////////////////////////////////////////////////////////////////////
bool FEMTetConstraint::initConstraint(PBDSimulationModel &model, const unsigned int particle1, const unsigned int particle2,
                                      const unsigned int particle3, const unsigned int particle4)
{
    m_bodies[0] = particle1;
    m_bodies[1] = particle2;
...
bool FEMTetConstraint::solvePositionConstraint(PBDSimulationModel &model, const unsigned int iter)
{
    ...
    const bool res = PositionBasedDynamics::solve_FEMTetraConstraint(
                ...
                m_invRestMat,
                //model.getValue<Real>(PBDSimulationModel::SOLID_STIFFNESS),
                //model.getValue<Real>(PBDSimulationModel::SOLID_POISSON_RATIO),
                model.SOLID_STIFFNESS.getValue(),
                model.SOLID_POISSON_RATIO.getValue(),
                handleInversion,
                corr1, corr2, corr3, corr4);
...
// StrainTetConstraint
//////////////////////////////////////////////////////////////////////////
bool StrainTetConstraint::initConstraint(PBDSimulationModel &model, const unsigned int particle1, const unsigned int particle2,
                                         const unsigned int particle3, const unsigned int particle4)
{
    m_bodies[0] = particle1;
    m_bodies[1] = particle2;
...
bool StrainTetConstraint::solvePositionConstraint(PBDSimulationModel &model, const unsigned int iter)
{
    ...
    const Real stiff = model.SOLID_STIFFNESS.getValue(); //model.getValue<Real>(PBDSimulationModel::SOLID_STIFFNESS);
    ...
    const bool res = PositionBasedDynamics::solve_StrainTetraConstraint(
                ...
                stiffness,
                stiffness,
                /*model.getValue<bool>(PBDSimulationModel::SOLID_NORMALIZE_STRETCH),
                model.getValue<bool>(PBDSimulationModel::SOLID_NORMALIZE_SHEAR),*/
                model.SOLID_NORMALIZE_STRETCH.getValue(),
                model.SOLID_NORMALIZE_SHEAR.getValue(),
                corr1, corr2, corr3, corr4);
...
//////////////////////////////////////////////////////////////////////////
bool RigidBodyContactConstraint::initConstraint(PBDSimulationModel &model, const unsigned int rbIndex1, const unsigned int rbIndex2,
...
bool RigidBodyContactConstraint::solveVelocityConstraint(PBDSimulationModel &model, const unsigned int iter)
{
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
...
//////////////////////////////////////////////////////////////////////////
bool ParticleRigidBodyContactConstraint::initConstraint(PBDSimulationModel &model,
...
//////////////////////////////////////////////////////////////////////////
bool ParticleTetContactConstraint::initConstraint(PBDSimulationModel &model,
...
//////////////////////////////////////////////////////////////////////////
bool StretchShearConstraint::initConstraint(PBDSimulationModel &model, const unsigned int particle1, const unsigned int particle2, const unsigned int quaternion1)
{
    m_bodies[0] = particle1;
    m_bodies[1] = particle2;
...
// BendTwistConstraint
//////////////////////////////////////////////////////////////////////////
bool BendTwistConstraint::initConstraint(PBDSimulationModel &model, const unsigned int quaternion1, const unsigned int quaternion2)
{
...
bool StretchBendingTwistingConstraint::initConstraint(
        PBDSimulationModel &model,
        ...
        Real torsionModulus)
{
    ...
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
    const PBDRigidBody &segment1 = *rb[m_bodies[0]];
    const PBDRigidBody &segment2 = *rb[m_bodies[1]];
...
bool StretchBendingTwistingConstraint::initConstraintBeforeProjection(PBDSimulationModel &model)
{
    DirectPositionBasedSolverForStiffRods::initBeforeProjection_StretchBendingTwistingConstraint(
                m_stiffnessCoefficientK,
                static_cast<Real>(1.0) / PBDTimeManager::getCurrent()->getTimeStepSize(),
                m_averageSegmentLength,
                m_stretchCompliance,
...
bool StretchBendingTwistingConstraint::updateConstraint(PBDSimulationModel &model)
{
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();
    const PBDRigidBody &segment1 = *rb[m_bodies[0]];
    const PBDRigidBody &segment2 = *rb[m_bodies[1]];
...
bool StretchBendingTwistingConstraint::solvePositionConstraint(PBDSimulationModel &model, const unsigned int iter)
{
    PBDSimulationModel::RigidBodyVector &rb = model.getRigidBodies();

    PBDRigidBody &segment1 = *rb[m_bodies[0]];
    PBDRigidBody &segment2 = *rb[m_bodies[1]];
...
bool DirectPositionBasedSolverForStiffRodsConstraint::initConstraintBeforeProjection(PBDSimulationModel &model)
{
    DirectPositionBasedSolverForStiffRods::initBeforeProjection_DirectPositionBasedSolverForStiffRodsConstraint(
                m_rodConstraints, static_cast<Real>(1.0) / PBDTimeManager::getCurrent()->getTimeStepSize(), m_lambdaSums);
    return true;
}


bool DirectPositionBasedSolverForStiffRodsConstraint::updateConstraint(PBDSimulationModel &model)
{
...
bool DirectPositionBasedSolverForStiffRodsConstraint::solvePositionConstraint(PBDSimulationModel &model, const unsigned int iter)
{
    ...
    for (size_t i(0); i < m_rodSegments.size(); ++i)
    {
        ...
        PBDRigidBody &rb1 = *rbs[segment.m_segmentIdx];
        if (rb1.getMass() != 0.0)
        {
