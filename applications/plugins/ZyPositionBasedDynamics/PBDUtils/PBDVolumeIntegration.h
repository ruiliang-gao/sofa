#ifndef PBDVOLUMEINTEGRATION_H
#define PBDVOLUMEINTEGRATION_H
...
namespace sofa
{
    namespace simulation
    {
        namespace PBDSimulation
        {
            namespace Utilities
            {
                class SOFA_ZY_POSITION_BASED_DYNAMICS_PLUGIN_API PBDVolumeIntegration
                {
                    private:
                        int A;
                        int B;
                    ...
                    public:
                        ...
                        PBDVolumeIntegration(const unsigned int nVertices, const unsigned int nFaces, Vector3r * const vertices, const unsigned int* indices);
