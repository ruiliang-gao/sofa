#ifndef PBD_INDEXED_FACE_MESH_H
#define PBD_INDEXED_FACE_MESH_H

#include <vector>
#include "PBDCommon/PBDCommon.h"
#include <iterator>

// TODO: Replace with SOFA's triangle mesh classes.
    ...
    namespace simulation
    {
        namespace PBDSimulation
        {
            namespace Utilities
            {
                ...
                public:
                    PBDIndexedFaceMesh(const unsigned int verticesPerFace = 3);
                    PBDIndexedFaceMesh(PBDIndexedFaceMesh const& other);
                    PBDIndexedFaceMesh& operator=(PBDIndexedFaceMesh const& other);
                    ~PBDIndexedFaceMesh();
                ...
                template<class PositionData>
                void PBDIndexedFaceMesh::updateNormals(const PositionData &pd, const unsigned int offset)
                {
                ...
                template<class PositionData>
                void PBDIndexedFaceMesh::updateVertexNormals(const PositionData &pd)
                {
