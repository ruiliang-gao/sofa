#ifndef PBDINDEXEDTETRAHEDRONMESH_H
#define PBDINDEXEDTETRAHEDRONMESH_H

#include <vector>
#include "PBDCommon/PBDCommon.h"

// TODO: Replace with SOFA's tetrahedron classes.
...
namespace sofa
{
    namespace simulation
    {
        namespace PBDSimulation
        {
            namespace Utilities
            {
                class PBDIndexedTetrahedronMesh
                {
                public:
                    struct Edge
                    {
...
#endif // PBDINDEXEDTETRAHEDRONMESH_H
