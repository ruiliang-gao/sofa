...
// ----------------------------------------------------------------------------------------------
void PBDMathFunctions::jacobiRotate(Matrix3r &A, Matrix3r &R, int p, int q)
{
...
// ----------------------------------------------------------------------------------------------
void PBDMathFunctions::eigenDecomposition(const Matrix3r &A, Matrix3r &eigenVecs, Vector3r &eigenVals)
{
...
*/
void PBDMathFunctions::polarDecomposition(const Matrix3r &A, Matrix3r &R, Matrix3r &U, Matrix3r &D)
{
...
*/
Real PBDMathFunctions::oneNorm(const Matrix3r &A)
{
...
*/
Real PBDMathFunctions::infNorm(const Matrix3r &A)
{
...
*/
void PBDMathFunctions::polarDecompositionStable(const Matrix3r &M, const Real tolerance, Matrix3r &R)
{
...
*/
void PBDMathFunctions::svdWithInversionHandling(const Matrix3r &A, Vector3r &sigma, Matrix3r &U, Matrix3r &VT)
{
...
// ----------------------------------------------------------------------------------------------
Real PBDMathFunctions::cotTheta(const Vector3r &v, const Vector3r &w)
{
...
// ----------------------------------------------------------------------------------------------
void PBDMathFunctions::crossProductMatrix(const Vector3r &v, Matrix3r &v_hat)
{
    v_hat << 0, -v(2), v(1),
        v(2), 0, -v(0),
        -v(1), v(0), 0;
...
// ----------------------------------------------------------------------------------------------
void PBDMathFunctions::extractRotation(const Matrix3r &A, Quaternionr &q,	const unsigned int maxIter)
{
