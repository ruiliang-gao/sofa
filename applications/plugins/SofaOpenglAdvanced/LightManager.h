...
#include <SofaOpenglAdvanced/Light.h>
...
#include <SofaOpenglAdvanced/OglShadowShader.h>
#endif
 ...
 *
 */
class SOFA_OPENGGL_ADVANCED_API LightManager : public core::visual::VisualManager
{
public:
