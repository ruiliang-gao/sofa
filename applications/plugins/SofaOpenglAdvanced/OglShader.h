...
class SOFA_OPENGGL_ADVANCED_API OglShader : public core::visual::Shader, public core::visual::VisualModel
{
public:
...
class SOFA_OPENGGL_ADVANCED_API OglShaderElement : public core::visual::ShaderElement
{
protected:
