 ...
 *
 */
class SOFA_OPENGGL_ADVANCED_API Light : public sofa::core::visual::VisualModel
{
public:
...
class SOFA_OPENGGL_ADVANCED_API DirectionalLight : public Light
{
public:
...
class SOFA_OPENGGL_ADVANCED_API PositionalLight : public Light
{
public:
...
class SOFA_OPENGGL_ADVANCED_API SpotLight : public PositionalLight
{
public:
