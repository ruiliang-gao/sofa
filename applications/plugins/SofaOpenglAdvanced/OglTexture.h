...
class SOFA_OPENGGL_ADVANCED_API OglTexture :  public core::visual::VisualModel, public OglShaderElement
{
public:
...
class SOFA_OPENGGL_ADVANCED_API OglTexture2D : public OglTexture
{
public:
