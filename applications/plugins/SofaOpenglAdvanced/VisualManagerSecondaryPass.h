...
#include <SofaOpenglAdvanced/VisualManagerPass.h>
...
class SOFA_OPENGGL_ADVANCED_API VisualManagerSecondaryPass : public component::visualmodel::VisualManagerPass
{
public:
