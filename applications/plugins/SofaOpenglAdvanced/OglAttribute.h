...
/** FLOAT ATTRIBUTE **/
class SOFA_OPENGGL_ADVANCED_API OglFloatAttribute : public OglAttribute<1, GL_FLOAT, float>
{
public:
...
class SOFA_OPENGGL_ADVANCED_API OglFloat2Attribute : public OglAttribute<2, GL_FLOAT, sofa::defaulttype::Vec<2, float> >
{
public:
...
class SOFA_OPENGGL_ADVANCED_API OglFloat3Attribute : public OglAttribute<3, GL_FLOAT, sofa::defaulttype::Vec<3, float> >
{
public:
...
class SOFA_OPENGGL_ADVANCED_API OglFloat4Attribute : public OglAttribute<4, GL_FLOAT, sofa::defaulttype::Vec<4, float> >
{
public:
...
/** INT ATTRIBUTE **/
class SOFA_OPENGGL_ADVANCED_API OglIntAttribute : public OglAttribute<1, GL_INT, int>
{
public:
...
class SOFA_OPENGGL_ADVANCED_API OglInt2Attribute : public OglAttribute<2, GL_INT, sofa::defaulttype::Vec<2, int> >
{
public:
...
class SOFA_OPENGGL_ADVANCED_API OglInt3Attribute : public OglAttribute<3, GL_INT, sofa::defaulttype::Vec<3, int> >
{
public:
...
class SOFA_OPENGGL_ADVANCED_API OglInt4Attribute : public OglAttribute<4, GL_INT, sofa::defaulttype::Vec<4, int> >
{
public:
...
class SOFA_OPENGGL_ADVANCED_API OglUIntAttribute : public OglAttribute<1, GL_UNSIGNED_INT, unsigned int>
{
public:
...
class SOFA_OPENGGL_ADVANCED_API OglUInt2Attribute : public OglAttribute<2, GL_UNSIGNED_INT, sofa::defaulttype::Vec<2, unsigned int> >
{
public:
...
class SOFA_OPENGGL_ADVANCED_API OglUInt3Attribute : public OglAttribute<3, GL_UNSIGNED_INT, sofa::defaulttype::Vec<3, unsigned int> >
{
public:
...
class SOFA_OPENGGL_ADVANCED_API OglUInt4Attribute : public OglAttribute<4, GL_UNSIGNED_INT, sofa::defaulttype::Vec<4, unsigned int> >
{
public:
