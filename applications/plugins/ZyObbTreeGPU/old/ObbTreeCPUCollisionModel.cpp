...
#ifndef SOFA_FLOAT
template class SOFA_OBBTREEGPUPLUGIN_API ObbTreeCPUCollisionModel<Vec3dTypes>;
#endif //SOFA_FLOAT
#ifndef SOFA_DOUBLE
template class SOFA_OBBTREEGPUPLUGIN_API ObbTreeCPUCollisionModel<Vec3fTypes>;
#endif //SOFA_DOUBLE
