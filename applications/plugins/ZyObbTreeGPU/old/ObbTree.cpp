...
void ObbVolume::fitObb(sofa::core::topology::BaseMeshTopology* mTopology, sofa::core::behavior::MechanicalState<Vec3Types>* mState, BuildNode& buildNode)
{
    ...
    for (int i = 0; i < buildNode.tris.size(); i++)
    {
        ...
        Vector3 pt1 = pos[tri[0]];
        Vector3 pt2 = pos[tri[1]];
        Vector3 pt3 = pos[tri[2]];
...
bool ObbTree::testOverlap(ObbTree &tree2, CollideResult& res)
{
    ...
    typename core::behavior::MechanicalState<Vec3Types>::ReadVecCoord pos = m_state->readPositions();
    typename core::behavior::MechanicalState<Vec3Types>::ReadVecCoord pos2 = tree2.getMState()->readPositions();
            ...
            case PAIR_TRINODE_OBB:
            {
                    ...
                    id1 >= 0 && id1 < m_triNodes.size())
                {
                    ...
                    if (tri_a >= 0 && tri_a < m_topology->getNbTriangles())
                    {
                        ...
                        tri_verts_a[0] = pos[triangle_a[0]];
                        tri_verts_a[1] = pos[triangle_a[1]];
                        tri_verts_a[2] = pos[triangle_a[2]];
            ...
            case PAIR_OBB_TRINODE:
            {
                    ...
                    id2 >= 0 && id2 < tree2.getTriNodes().size())
                {
                    ...
                    if (tri_b >= 0 && tri_b < tree2.getTopology()->getNbTriangles())
                    {
                        ...
                        tri_verts_b[0] = pos2[triangle_b[0]];
                        tri_verts_b[1] = pos2[triangle_b[1]];
                        tri_verts_b[2] = pos2[triangle_b[2]];
