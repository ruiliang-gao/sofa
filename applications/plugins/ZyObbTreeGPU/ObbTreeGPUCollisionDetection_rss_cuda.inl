...
void ObbTreeGPU_BVHCollide(sofa::component::collision::OBBContainer* model1, sofa::component::collision::OBBContainer* model2, std::vector<std::pair<int, int> >& collisionList
	...
	, int& nIntersecting)
{
    RSSNode* obbTree1 = (RSSNode*)model1->rssTree;
    RSSNode* obbTree2 = (RSSNode*)model2->rssTree;
	...
	while (nActiveSplits)
	{
        ...
        // banane
        traverseTree<RSSNode, RSS, QUEUE_SIZE_PER_TASK, QUEUE_SIZE_PER_TASK_INIT, TRAVERSAL_THREADS> << < QUEUE_NTASKS, TRAVERSAL_THREADS >> >
	...
	int& nIntersecting)
{
	...
	while (nActiveSplits)
	{
        ...
        traverseTree<RSSNode, RSS, QUEUE_SIZE_PER_TASK, QUEUE_SIZE_PER_TASK_INIT, TRAVERSAL_THREADS> << < QUEUE_NTASKS, TRAVERSAL_THREADS, 0, *(workerUnit->_stream) >> >
			(obbTree1, d_vertices1, d_triIndices1, obbTree2, d_vertices2, d_triIndices2,
							 ...
							 std::vector<cudaEvent_t>& worker_startEvents, std::vector<cudaEvent_t>& worker_stopEvents)
{
	...
	for (unsigned int k = 0; k < numIterations; k++)
	{
        RSSNode* obbTree1 = (RSSNode*)models1[k]->rssTree;
        RSSNode* obbTree2 = (RSSNode*)models2[k]->rssTree;
        ...
        traverseTree<RSSNode, RSS, QUEUE_SIZE_PER_TASK, QUEUE_SIZE_PER_TASK_INIT, TRAVERSAL_THREADS> << < QUEUE_NTASKS, TRAVERSAL_THREADS, 0, workerStreams[k] >> >
			(obbTree1, d_vertices1, d_triIndices1, obbTree2, d_vertices2, d_triIndices2,
