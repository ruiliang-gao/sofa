...
{
#ifndef SOFA_DOUBLE
template class SOFA_SPECIFIC_USER_INTERACTION_API FixParticlePerformer<defaulttype::Vec3fTypes>;
...
#endif
#ifndef SOFA_FLOAT
template class SOFA_SPECIFIC_USER_INTERACTION_API FixParticlePerformer<defaulttype::Vec3dTypes>;
