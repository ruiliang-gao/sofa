...
#include <SofaSpecificBoundaryConditions/LinearVelocityConstraint.inl>
...
#ifndef SOFA_FLOAT
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API LinearVelocityConstraint<Vec3dTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API LinearVelocityConstraint<Vec2dTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API LinearVelocityConstraint<Vec1dTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API LinearVelocityConstraint<Vec6dTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API LinearVelocityConstraint<Rigid3dTypes>;
#endif
#ifndef SOFA_DOUBLE
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API LinearVelocityConstraint<Vec3fTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API LinearVelocityConstraint<Vec2fTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API LinearVelocityConstraint<Vec1fTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API LinearVelocityConstraint<Vec6fTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API LinearVelocityConstraint<Rigid3fTypes>;
#endif
