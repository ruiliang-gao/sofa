...
#ifndef SOFA_FLOAT
extern template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API PartialLinearMovementConstraint<defaulttype::Vec3dTypes>;
extern template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API PartialLinearMovementConstraint<defaulttype::Vec2dTypes>;
extern template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API PartialLinearMovementConstraint<defaulttype::Vec1dTypes>;
extern template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API PartialLinearMovementConstraint<defaulttype::Vec6dTypes>;
extern template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API PartialLinearMovementConstraint<defaulttype::Rigid3dTypes>;
#endif
#ifndef SOFA_DOUBLE
extern template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API PartialLinearMovementConstraint<defaulttype::Vec3fTypes>;
extern template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API PartialLinearMovementConstraint<defaulttype::Vec2fTypes>;
extern template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API PartialLinearMovementConstraint<defaulttype::Vec1fTypes>;
extern template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API PartialLinearMovementConstraint<defaulttype::Vec6fTypes>;
extern template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API PartialLinearMovementConstraint<defaulttype::Rigid3fTypes>;
#endif
#endif
