...
#include <SofaSpecificBoundaryConditions/ProjectToPointConstraint.inl>
...
#ifndef SOFA_FLOAT
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API ProjectToPointConstraint<Vec3dTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API ProjectToPointConstraint<Vec2dTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API ProjectToPointConstraint<Vec1dTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API ProjectToPointConstraint<Vec6dTypes>;
//template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API ProjectToPointConstraint<Rigid3dTypes>;
//template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API ProjectToPointConstraint<Rigid2dTypes>;
#endif
#ifndef SOFA_DOUBLE
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API ProjectToPointConstraint<Vec3fTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API ProjectToPointConstraint<Vec2fTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API ProjectToPointConstraint<Vec1fTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API ProjectToPointConstraint<Vec6fTypes>;
//template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API ProjectToPointConstraint<Rigid3fTypes>;
//template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API ProjectToPointConstraint<Rigid2fTypes>;
#endif
