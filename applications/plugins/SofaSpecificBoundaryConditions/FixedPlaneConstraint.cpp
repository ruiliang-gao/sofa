...
#include <SofaSpecificBoundaryConditions/FixedPlaneConstraint.inl>
...
#ifndef SOFA_FLOAT
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API FixedPlaneConstraint<Rigid3dTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API FixedPlaneConstraint<Vec3dTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API FixedPlaneConstraint<Vec6dTypes>;
#endif
#ifndef SOFA_DOUBLE
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API FixedPlaneConstraint<Rigid3fTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API FixedPlaneConstraint<Vec3fTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API FixedPlaneConstraint<Vec6fTypes>;
#endif
