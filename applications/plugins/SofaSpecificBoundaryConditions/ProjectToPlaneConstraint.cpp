...
#include <SofaSpecificBoundaryConditions/ProjectToPlaneConstraint.inl>
...
#ifndef SOFA_FLOAT
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API ProjectToPlaneConstraint<Vec3dTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API ProjectToPlaneConstraint<Vec2dTypes>;
//template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API ProjectToPlaneConstraint<Vec1dTypes>;
//template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API ProjectToPlaneConstraint<Vec6dTypes>;
//template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API ProjectToPlaneConstraint<Rigid3dTypes>;
//template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API ProjectToPlaneConstraint<Rigid2dTypes>;
#endif
#ifndef SOFA_DOUBLE
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API ProjectToPlaneConstraint<Vec3fTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API ProjectToPlaneConstraint<Vec2fTypes>;
//template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API ProjectToPlaneConstraint<Vec1fTypes>;
//template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API ProjectToPlaneConstraint<Vec6fTypes>;
//template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API ProjectToPlaneConstraint<Rigid3fTypes>;
//template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API ProjectToPlaneConstraint<Rigid2fTypes>;
#endif
