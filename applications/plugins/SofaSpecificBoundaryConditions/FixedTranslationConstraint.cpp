...
#include <SofaSpecificBoundaryConditions/FixedTranslationConstraint.inl>
...
#ifndef SOFA_FLOAT
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API FixedTranslationConstraint<Rigid3dTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API FixedTranslationConstraint<Rigid2dTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API FixedTranslationConstraint<Vec6dTypes>;
#endif
#ifndef SOFA_DOUBLE
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API FixedTranslationConstraint<Rigid3fTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API FixedTranslationConstraint<Rigid2fTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API FixedTranslationConstraint<Vec6fTypes>;
#endif
