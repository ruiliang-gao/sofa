...
#include <SofaSpecificBoundaryConditions/PositionBasedDynamicsConstraint.inl>
...
#ifndef SOFA_FLOAT
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API PositionBasedDynamicsConstraint<Vec3dTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API PositionBasedDynamicsConstraint<Vec2dTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API PositionBasedDynamicsConstraint<Vec1dTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API PositionBasedDynamicsConstraint<Vec6dTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API PositionBasedDynamicsConstraint<Rigid3dTypes>;
//template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API PositionBasedDynamicsConstraint<Rigid2dTypes>;
#endif
#ifndef SOFA_DOUBLE
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API PositionBasedDynamicsConstraint<Vec3fTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API PositionBasedDynamicsConstraint<Vec2fTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API PositionBasedDynamicsConstraint<Vec1fTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API PositionBasedDynamicsConstraint<Vec6fTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API PositionBasedDynamicsConstraint<Rigid3fTypes>;
//template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API PositionBasedDynamicsConstraint<Rigid2fTypes>;
#endif
