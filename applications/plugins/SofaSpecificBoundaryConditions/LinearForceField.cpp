...
#include <SofaSpecificBoundaryConditions/LinearForceField.inl>
...
// .add< LinearForceField<Rigid2fTypes> >()
        ...
        ;
#ifndef SOFA_FLOAT
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API LinearForceField<Vec3dTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API LinearForceField<Vec2dTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API LinearForceField<Vec1dTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API LinearForceField<Vec6dTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API LinearForceField<Rigid3dTypes>;
// template class SOFA_BOUNDARY_CONDITION_API LinearForceField<Rigid2dTypes>;
#endif
#ifndef SOFA_DOUBLE
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API LinearForceField<Vec3fTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API LinearForceField<Vec2fTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API LinearForceField<Vec1fTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API LinearForceField<Vec6fTypes>;
template class SOFA_SPECIFIC_BOUNDARY_CONDITIONS_API LinearForceField<Rigid3fTypes>;
