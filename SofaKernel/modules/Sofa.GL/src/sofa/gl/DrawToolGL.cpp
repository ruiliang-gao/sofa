...
//TIPS - DS
typedef sofa::type::fixed_array<float, 3> Float3;
typedef sofa::type::fixed_array<float, 2> Float2;

void DrawToolGL::DrawTextureQuad(int x, int y, int width, int height, sofa::gl::Texture* InTexture, bool bFromRightCorner)
{
    GLint viewport[4];
    glGetIntegerv(GL_VIEWPORT, viewport);
