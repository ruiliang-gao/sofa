...
public:
    ...
    sofa::helper::vector< vector < vector <uint32_t> > > & getFacets() { return facets; }
    const sofa::helper::vector< vector < vector <uint32_t> > > & getFacets() const { return facets; }
...
protected:
    ...
    sofa::helper::vector< sofa::helper::vector < sofa::helper::vector <uint32_t> > > facets;
