...
public:
    ...
    {
        RigidCoord t;
        t.center = Pos(  SReal(sofa::helper::drand(a)), SReal(sofa::helper::drand(a)), SReal(sofa::helper::drand(a)) );
        t.orientation = Quat::fromEuler( SReal(sofa::helper::drand(a)),SReal(sofa::helper::drand(a)), SReal(sofa::helper::drand(a)));
        return t;
    }
...
public:
    ...
    {
        Deriv result;
        set( result, Real(    sofa::helper::drand(minMagnitude,maxMagnitude)), Real(    sofa::helper::drand(minMagnitude,maxMagnitude)), Real(    sofa::helper::drand(minMagnitude,maxMagnitude)),
                     Real(    sofa::helper::drand(minMagnitude,maxMagnitude)), Real(    sofa::helper::drand(minMagnitude,maxMagnitude)), Real(    sofa::helper::drand(minMagnitude,maxMagnitude)) );
        return result;
    }
    ...
    static Coord interpolate(const sofa::helper::vector< Coord > & ancestors, const sofa::helper::vector< Real > & coefs)
    {
        ...
        for (unsigned int i = 0; i < ancestors.size(); i++)
        {
            ...
            Quater<Real> q = ancestors[i].getOrientation();
...
public:
    ...
    {
        RigidCoord t;
        t.center = Pos( SReal(sofa::helper::drand(a)), SReal(sofa::helper::drand(a)));
        t.orientation = SReal(sofa::helper::drand(a));
        return t;
    }
    ...
    Real norm() const
    {
        return sofa::helper::rsqrt(norm2());
    }
