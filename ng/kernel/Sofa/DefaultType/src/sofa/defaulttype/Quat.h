...
#include <sofa/defaulttype/Quater.h>
...
{
typedef Quater<double> Quatd; ///< alias
...
template<class T>
struct DataTypeInfo< sofa::defaulttype::Quater<T> > : public FixedArrayTypeInfo< sofa::defaulttype::Quater<T> >
{
