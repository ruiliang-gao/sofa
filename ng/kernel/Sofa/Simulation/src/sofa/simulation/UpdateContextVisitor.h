...
class SOFA_SIMULATION_API UpdateContextVisitor : public Visitor
{
public:
...
class SOFA_SIMULATION_API UpdateSimulationContextVisitor : public UpdateContextVisitor
{
public:
...
class SOFA_SIMULATION_API UpdateVisualContextVisitor : public UpdateContextVisitor
{
public:
