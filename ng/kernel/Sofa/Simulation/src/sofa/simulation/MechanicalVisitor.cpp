...
template class SOFA_SIMULATION_API MechanicalVAvailVisitor<V_COORD>;
template class SOFA_SIMULATION_API MechanicalVAvailVisitor<V_DERIV>;
template class SOFA_SIMULATION_API MechanicalVAllocVisitor<V_COORD>;
template class SOFA_SIMULATION_API MechanicalVAllocVisitor<V_DERIV>;
template class SOFA_SIMULATION_API MechanicalVReallocVisitor<V_COORD>;
template class SOFA_SIMULATION_API MechanicalVReallocVisitor<V_DERIV>;
template class SOFA_SIMULATION_API MechanicalVFreeVisitor<V_COORD>;
template class SOFA_SIMULATION_API MechanicalVFreeVisitor<V_DERIV>;
template class SOFA_SIMULATION_API MechanicalVInitVisitor<V_COORD>;
template class SOFA_SIMULATION_API MechanicalVInitVisitor<V_DERIV>;
