...
class SOFA_SIMULATION_API MechanicalGetMatrixDimensionVisitor : public BaseMechanicalVisitor
{
public:
...
/** Compute the size of a mechanical matrix (mass or stiffness) of the whole scene */
class SOFA_SIMULATION_API MechanicalGetConstraintJacobianVisitor : public BaseMechanicalVisitor
{
public:
...
/** Compute the size of a mechanical matrix (mass or stiffness) of the whole scene */
class SOFA_SIMULATION_API MechanicalIntegrateConstraintsVisitor : public BaseMechanicalVisitor
{
public:
...
class SOFA_SIMULATION_API MechanicalAddMBK_ToMatrixVisitor : public MechanicalVisitor
{
public:
    const sofa::core::behavior::MultiMatrixAccessor* matrix;
...
class SOFA_SIMULATION_API MechanicalAddSubMBK_ToMatrixVisitor : public MechanicalVisitor
{
public:
    const sofa::core::behavior::MultiMatrixAccessor* matrix;
...
class SOFA_SIMULATION_API MechanicalMultiVectorToBaseVectorVisitor : public BaseMechanicalVisitor
{
public:
...
class SOFA_SIMULATION_API MechanicalMultiVectorPeqBaseVectorVisitor : public BaseMechanicalVisitor
{
public:
...
class SOFA_SIMULATION_API MechanicalMultiVectorFromBaseVectorVisitor : public BaseMechanicalVisitor
{
public:
    sofa::defaulttype::BaseVector *src;
