...
class SOFA_SIMULATION_API VisualVisitor : public Visitor
{
public:
...
class SOFA_SIMULATION_API VisualDrawVisitor : public VisualVisitor
{
public:
    bool hasShader;
...
class SOFA_SIMULATION_API VisualUpdateVisitor : public Visitor
{
public:
...
class SOFA_SIMULATION_API VisualInitVisitor : public Visitor
{
public:
...
class SOFA_SIMULATION_API VisualComputeBBoxVisitor : public Visitor
{
public:
    SReal minBBox[3];
    SReal maxBBox[3];
...
class SOFA_SIMULATION_API VisualClearVisitor : public VisualVisitor
{
public:
