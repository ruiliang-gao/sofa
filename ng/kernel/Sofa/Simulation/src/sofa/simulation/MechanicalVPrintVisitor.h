...
/** Print a vector */
class SOFA_SIMULATION_API MechanicalVPrintVisitor : public Visitor
{
public:
...
class SOFA_SIMULATION_API MechanicalVPrintWithElapsedTimeVisitor : public Visitor
{
protected:
    sofa::core::ConstMultiVecId v_;
    unsigned count_;
...
class SOFA_SIMULATION_API DofPrintVisitor : public Visitor
{
public:
