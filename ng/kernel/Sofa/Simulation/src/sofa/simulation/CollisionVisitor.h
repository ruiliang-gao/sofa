...
class SOFA_SIMULATION_API CollisionVisitor : public Visitor
{
public:
...
class SOFA_SIMULATION_API CollisionResetVisitor : public CollisionVisitor
{
...
class SOFA_SIMULATION_API CollisionDetectionVisitor : public CollisionVisitor
{
public:
...
class SOFA_SIMULATION_API CollisionResponseVisitor : public CollisionVisitor
{
public:
