...
*****************************************************************************/
#ifndef SOFA_MESSAGING_FILEINFO_H
#define SOFA_MESSAGING_FILEINFO_H

#include <iostream>
#include <string>
#include <cstring>
#include <sofa/messaging/config.h>
#include <sstream>
#include <set>
...
#define SOFA_FILE_INFO sofa::messaging::FileInfo::SPtr(new sofa::messaging::FileInfo(__FILE__, __LINE__))
#define SOFA_FILE_INFO_COPIED_FROM(file,line) sofa::messaging::FileInfo::SPtr(new sofa::messaging::FileInfoOwningFilename(file,line))
