...
#include <sofa/messaging/MessageHandler.h>
#include <sofa/messaging/Message.h>
#include <vector>
...
///
///
class SOFA_MESSAGING_API RoutingMessageHandler : public MessageHandler
{
public:
...
///
class SOFA_MESSAGING_API MainRoutingMessageHandler
{
public:
