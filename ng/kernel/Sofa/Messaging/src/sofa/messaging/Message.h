...
class SOFA_MESSAGING_API Message
{
public:
...
template<> SOFA_MESSAGING_API Message& Message::operator<<(const FileInfo::SPtr &fi) ;

SOFA_MESSAGING_API std::ostream& operator<< (std::ostream&, const Message&) ;
SOFA_MESSAGING_API const std::string toString(const Message::Type type) ;
