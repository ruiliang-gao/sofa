...
#define nmsg_info(emitter)       sofa::messaging::MessageDispatcher::null()
#define nmsg_deprecated(emitter) sofa::messaging::MessageDispatcher::null()
#define nmsg_advice(emitter) sofa::messaging::MessageDispatcher::null()
#define nmsg_warning(emitter)    sofa::messaging::MessageDispatcher::null()
#define nmsg_error(emitter)      sofa::messaging::MessageDispatcher::null()
#define nmsg_fatal(emitter)      sofa::messaging::MessageDispatcher::null()
...
#define olddmsg_info(emitter)       sofa::messaging::MessageDispatcher::info(sofa::messaging::Message::Dev, sofa::messaging::getComponentInfo(emitter), SOFA_FILE_INFO)
#define olddmsg_deprecated(emitter) sofa::messaging::MessageDispatcher::deprecated(sofa::messaging::Message::Dev, sofa::messaging::getComponentInfo(emitter), SOFA_FILE_INFO)
#define olddmsg_warning(emitter)    sofa::messaging::MessageDispatcher::warning(sofa::messaging::Message::Dev, sofa::messaging::getComponentInfo(emitter), SOFA_FILE_INFO)
#define olddmsg_error(emitter)      sofa::messaging::MessageDispatcher::error(sofa::messaging::Message::Dev, sofa::messaging::getComponentInfo(emitter), SOFA_FILE_INFO)
#define olddmsg_fatal(emitter)      sofa::messaging::MessageDispatcher::fatal(sofa::messaging::Message::Dev, sofa::messaging::getComponentInfo(emitter), SOFA_FILE_INFO)
#define olddmsg_advice(emitter)      sofa::messaging::MessageDispatcher::advice(sofa::messaging::Message::Dev, sofa::messaging::getComponentInfo(emitter), SOFA_FILE_INFO)
#else
...
#define oldmsg_info(emitter)       sofa::messaging::MessageDispatcher::info(sofa::messaging::Message::Runtime, sofa::messaging::getComponentInfo(emitter), SOFA_FILE_INFO)
#define oldmsg_deprecated(emitter) sofa::messaging::MessageDispatcher::deprecated(sofa::messaging::Message::Runtime, sofa::messaging::getComponentInfo(emitter), SOFA_FILE_INFO)
#define oldmsg_warning(emitter)    sofa::messaging::MessageDispatcher::warning(sofa::messaging::Message::Runtime, sofa::messaging::getComponentInfo(emitter), SOFA_FILE_INFO)
#define oldmsg_error(emitter)      sofa::messaging::MessageDispatcher::error(sofa::messaging::Message::Runtime, sofa::messaging::getComponentInfo(emitter), SOFA_FILE_INFO)
#define oldmsg_fatal(emitter)      sofa::messaging::MessageDispatcher::fatal(sofa::messaging::Message::Runtime, sofa::messaging::getComponentInfo(emitter), SOFA_FILE_INFO)
#define oldmsg_advice(emitter)      sofa::messaging::MessageDispatcher::advice(sofa::messaging::Message::Runtime, sofa::messaging::getComponentInfo(emitter), SOFA_FILE_INFO)

#define logmsg_info(emitter)       sofa::messaging::MessageDispatcher::info(sofa::messaging::Message::Log, sofa::messaging::getComponentInfo(emitter), SOFA_FILE_INFO)
#define logmsg_deprecated(emitter) sofa::messaging::MessageDispatcher::deprecated(sofa::messaging::Message::Log, sofa::messaging::getComponentInfo(emitter), SOFA_FILE_INFO)
#define logmsg_warning(emitter)    sofa::messaging::MessageDispatcher::warning(sofa::messaging::Message::Log, sofa::messaging::getComponentInfo(emitter), SOFA_FILE_INFO)
#define logmsg_error(emitter)      sofa::messaging::MessageDispatcher::error(sofa::messaging::Message::Log, sofa::messaging::getComponentInfo(emitter), SOFA_FILE_INFO)
#define logmsg_fatal(emitter)      sofa::messaging::MessageDispatcher::fatal(sofa::messaging::Message::Log, sofa::messaging::getComponentInfo(emitter), SOFA_FILE_INFO)
#define logmsg_advice(emitter)      sofa::messaging::MessageDispatcher::advice(sofa::messaging::Message::Log, sofa::messaging::getComponentInfo(emitter), SOFA_FILE_INFO)

#define msg_info_withfile(emitter, file, line)       sofa::messaging::MessageDispatcher::info(sofa::messaging::Message::Runtime, sofa::messaging::getComponentInfo(emitter), SOFA_FILE_INFO_COPIED_FROM(file,line))
#define msg_deprecated_withfile(emitter, file, line) sofa::messaging::MessageDispatcher::deprecated(sofa::messaging::Message::Runtime, sofa::messaging::getComponentInfo(emitter), SOFA_FILE_INFO_COPIED_FROM(file,line))
#define msg_warning_withfile(emitter, file,line)    sofa::messaging::MessageDispatcher::warning(sofa::messaging::Message::Runtime, sofa::messaging::getComponentInfo(emitter), SOFA_FILE_INFO_COPIED_FROM(file,line))
#define msg_error_withfile(emitter, file,line)      sofa::messaging::MessageDispatcher::error(sofa::messaging::Message::Runtime, sofa::messaging::getComponentInfo(emitter), SOFA_FILE_INFO_COPIED_FROM(file,line))
#define msg_fatal_withfile(emitter, file,line)      sofa::messaging::MessageDispatcher::fatal(sofa::messaging::Message::Runtime, sofa::messaging::getComponentInfo(emitter), SOFA_FILE_INFO_COPIED_FROM(file,line))
#define msg_advice_withfile(emitter, file,line)      sofa::messaging::MessageDispatcher::advice(sofa::messaging::Message::Runtime, sofa::messaging::getComponentInfo(emitter), SOFA_FILE_INFO_COPIED_FROM(file,line))

#define FILEINFO(filename, line) sofa::messaging::FileInfo(filename, line)
...
/// THE INFO BEAST
#define MSGINFO_1(x) if( sofa::messaging::notMuted(x) ) oldmsg_info(x)
#define MSGINFO_0()  if( sofa::messaging::notMuted(this) ) oldmsg_info(this)
...
/// THE ADVICE BEAST
#define MSGADVICE_1(x) if( sofa::messaging::notMuted(x) ) oldmsg_advice(x)
#define MSGADVICE_0()  if( sofa::messaging::notMuted(this) ) oldmsg_advice(this)
...
/// THE INFO BEAST
#define DMSGINFO_1(x) if( sofa::messaging::notMuted(x) ) olddmsg_info(x)
#define DMSGINFO_0()  if( sofa::messaging::notMuted(this) ) olddmsg_info(this)
...
/// THE ADVICE BEAST
#define DMSGADVICE_1(x) if( sofa::messaging::notMuted(x) ) olddmsg_advice(x)
#define DMSGADVICE_0()  if( sofa::messaging::notMuted(this) ) olddmsg_advice(this)
