...
#include <sofa/helper/rendering/FrameBufferObject.h>
#include <sofa/helper/rendering/Transformation.h>
...
public:
    ...
    helper::rendering::FrameBufferObject*& frameBufferObject() { return m_boundFrameBuffer; }
    helper::rendering::FrameBufferObject*& frameBufferObject() const { return m_boundFrameBuffer; }
    ...
    sofa::helper::rendering::Transformation& sceneTransform() { return m_sceneTransform; }
    const sofa::helper::rendering::Transformation& sceneTransform() const { return m_sceneTransform; }
