...
******************************************************************************/
#ifndef SOFA_HELPER_TYPES_VECTOR_H
#define SOFA_HELPER_TYPES_VECTOR_H
...
#include <sofa/helper/types/MemoryManager.h>
...
template <class T>
class SOFA_HELPER_TYPES_API vector<T, CPUMemoryManager<T> > : public std::vector<T, std::allocator<T> >
{
public:
...
#endif //SOFA_HELPER_TYPES_VECTOR_H
