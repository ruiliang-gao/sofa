...
******************************************************************************/
#ifndef SOFA_HELPER_TYPES_ACCESSOR_H
#define SOFA_HELPER_TYPES_ACCESSOR_H
...
template<class T, class Alloc>
class ReadAccessor< helper::types::vector<T,Alloc> > : public ReadAccessorVector< helper::types::vector<T,Alloc> >
{
public:
    typedef ReadAccessorVector< helper::types::vector<T,Alloc> > Inherit;
    typedef typename Inherit::container_type container_type;
    ReadAccessor(const container_type& c) : Inherit(c) {}
};

template<class T, class Alloc>
class WriteAccessor< helper::types::vector<T,Alloc> > : public WriteAccessorVector< helper::types::vector<T,Alloc> >
{
public:
    typedef WriteAccessorVector< helper::types::vector<T,Alloc> > Inherit;
    typedef typename Inherit::container_type container_type;
    WriteAccessor(container_type& c) : Inherit(c) {}
};
