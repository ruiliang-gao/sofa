...
#ifndef SOFA_HELPER_TYPES_FIXED_ARRAY_H
#define SOFA_HELPER_TYPES_FIXED_ARRAY_H
...
extern template class SOFA_HELPER_TYPES_API sofa::helper::types::fixed_array<float, 4> ;
#endif //
