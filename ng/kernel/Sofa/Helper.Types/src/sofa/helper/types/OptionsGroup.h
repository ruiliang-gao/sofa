...
******************************************************************************/
#ifndef SOFA_HELPER_TYPES_OPTIONSGROUP_H
#define SOFA_HELPER_TYPES_OPTIONSGROUP_H
...
class SOFA_HELPER_TYPES_API OptionsGroup
{
public :
...
protected:
    ...
    helper::types::vector<std::string> textItems    ;
...
#endif /* SOFA_HELPER_TYPES_OPTIONSGROUP_H */
