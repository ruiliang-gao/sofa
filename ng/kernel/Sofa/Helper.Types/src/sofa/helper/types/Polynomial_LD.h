...
public :
    ...
    //void SetPower(const sofa::helper::types::vector<int> & m_powers)   {for(unsigned int i=0;i<N;i++) powers[i]=m_powers[i];}
...
public :
    ...
    //typedef sofa::helper::types::vector< Monomial_LD<Real,N> > MonomialsList;
...
#ifndef SOFA_FLOAT
extern template class SOFA_HELPER_TYPES_API Monomial_LD<double,1>;
extern template class SOFA_HELPER_TYPES_API Monomial_LD<double,2>;
extern template class SOFA_HELPER_TYPES_API Monomial_LD<double,3>;
extern template class SOFA_HELPER_TYPES_API Monomial_LD<double,4>;
extern template class SOFA_HELPER_TYPES_API Monomial_LD<double,5>;

extern template class SOFA_HELPER_TYPES_API Polynomial_LD<double,1>;
extern template class SOFA_HELPER_TYPES_API Polynomial_LD<double,2>;
extern template class SOFA_HELPER_TYPES_API Polynomial_LD<double,3>;
extern template class SOFA_HELPER_TYPES_API Polynomial_LD<double,4>;
extern template class SOFA_HELPER_TYPES_API Polynomial_LD<double,5>;
#endif

#ifndef SOFA_DOUBLE
extern template class SOFA_HELPER_TYPES_API Monomial_LD<float,1>;
extern template class SOFA_HELPER_TYPES_API Monomial_LD<float,2>;
extern template class SOFA_HELPER_TYPES_API Monomial_LD<float,3>;
extern template class SOFA_HELPER_TYPES_API Monomial_LD<float,4>;
extern template class SOFA_HELPER_TYPES_API Monomial_LD<float,5>;

extern template class SOFA_HELPER_TYPES_API Polynomial_LD<float,1>;
extern template class SOFA_HELPER_TYPES_API Polynomial_LD<float,2>;
extern template class SOFA_HELPER_TYPES_API Polynomial_LD<float,3>;
extern template class SOFA_HELPER_TYPES_API Polynomial_LD<float,4>;
extern template class SOFA_HELPER_TYPES_API Polynomial_LD<float,5>;
#endif
