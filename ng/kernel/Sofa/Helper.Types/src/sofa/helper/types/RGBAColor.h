...
#include <sofa/helper/types/fixed_array.h>
 ...
 */
class SOFA_HELPER_TYPES_API RGBAColor : public fixed_array<float, 4>
{
public:
    ...
    friend SOFA_HELPER_TYPES_API std::ostream& operator<<(std::ostream& i, const RGBAColor& t) ;
    friend SOFA_HELPER_TYPES_API std::istream& operator>>(std::istream& i, RGBAColor& t) ;
